...
**We don't share your data.** We don't sell it, give it to advertisers, or use it for marketing. The only exception is if required by law.

## Age Requirement

You must be 13+ to use Discord and this bot. We do not knowingly provide services or process data on anybody under the age of 13.

## Data Location

Data is stored on secure servers. We process data based on legitimate interest to provide bot services.

## Policy Updates

We may update this policy. Changes will be announced in our support server.
...
For data deletion, provide your server ID and confirm you're a server admin.
