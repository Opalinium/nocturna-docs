...
These Terms constitute a legally binding agreement between you (the "User" or "Server Administrator") and the operator of Nocturna. By inviting the Bot to your Discord server or interacting with it, you acknowledge that you have read, understood, and agree to be bound by these Terms.
...
You must be at least 13 years old (or the minimum age required in your jurisdiction) to use Discord and this Bot. By using the Bot, you represent and warrant that you meet this age requirement.
...
- Use the Bot to violate any local, state, national, or international law
- Use the Bot to harass, abuse, threaten, or intimidate other users
- Attempt to gain unauthorized access to the Bot's systems or databases
- Exploit bugs or vulnerabilities in the Bot for unfair advantage
...
- Configuring the Bot appropriately for their server's needs
- Ensuring their server's use of the Bot complies with these Terms
...
- Manage Messages (for purge and moderation features)
- Manage Roles (for role menu and autorole features)
- Kick Members / Ban Members / Moderate Members (for moderation features)
...
- Content filtering based on regex patterns, word lists, and custom filter rules
- Automatic timeouts for filter violations with configurable strike systems
- Raid detection and automatic moderation responses
- Message purging and bulk deletion operations

**You acknowledge that:**
- Automated moderation may produce false positives or false negatives
...
- Content created using Bot commands (tags, custom commands, role menus, filter rules)
...
- Ensure fair usage across all servers
...
**Thank you for using Nocturna!**

*These Terms of Service are effective as of the date stated above and apply to all users and servers using Nocturna.*
